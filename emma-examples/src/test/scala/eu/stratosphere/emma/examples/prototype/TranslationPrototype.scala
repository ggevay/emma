...
import eu.stratosphere.emma.api.CSVInputFormat
import eu.stratosphere.emma.api.CSVOutputFormat
import eu.stratosphere.emma.api.DataBag
import eu.stratosphere.emma.api._
import eu.stratosphere.emma.api.emma
import eu.stratosphere.emma.api.model.Identity
import eu.stratosphere.emma.api.model.id
import eu.stratosphere.emma.examples.Algorithm
import eu.stratosphere.emma.examples.Algorithm
import eu.stratosphere.emma.examples.graphs.BeliefPropagation.Schema.Belief
import eu.stratosphere.emma.examples.graphs.BeliefPropagation.Schema.Message
import eu.stratosphere.emma.examples.graphs.BeliefPropagation.Schema.Potential
import eu.stratosphere.emma.examples.graphs.BeliefPropagation.Schema.Variable
